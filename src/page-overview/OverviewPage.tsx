    ...
    <OverviewPageDiv>
      <div className="min-h-screen">
        <nav className="container mx-auto">
          ...
          <div className="sm:hidden">
            <div className="flex justify-center">
              <div className="mt-10">
                <h3 className="inline-flex items-center font-medium leading-5 text-gray-900 text-green-700">
                  Criminal Justice
                </h3>
                <h3 className="inline-flex items-center font-medium leading-5 text-gray-900 text-red-500">
                  COVID-19
                </h3>
              </div>
            </div>
              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  <div className="sm:-my-px sm:ml-6 sm:flex">
                    <h3 className="inline-flex items-center px-1 pt-1 font-medium leading-5 text-gray-900 text-green-700">
                      Criminal Justice
                    </h3>
                    <h3 className="inline-flex items-center px-1 pt-1 font-medium leading-5 text-gray-900 text-red-500">
                      COVID-19
                    </h3>
                  </div>
                </div>
                ...
                <div className="sm:ml-6 sm:flex sm:items-center">
                  <a
                    href="#"
                    className="mx-4 px-1 pt-1 font-medium text-green-700"
                  >
                    About
                  </a>
                  <a
        ...
        <main className="py-4 sm:py-6 flex justify-between items-start container mx-auto">
            ...
            <div className="my-6">
              ...
              >
                <div className="w-24 text-center flex-shrink-0">
                  <p className="text-base sm:leading-6 font-light text-teal-400">
                    Incarcerated
                  </p>
                  <div>
                    <input
                      ...
                      className="slider-input text-teal-600 border-teal-600"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="w-24 text-center flex-shrink-0">
                  <label
                    className="text-base sm:leading-6 font-light text-red-500"
                  ...
                  <div>
                    <input
                      ...
                      className="slider-input text-red-600 border-red-600"
                      min="0"
                      max="100"
                      required
                    />
          ...
          <div className="w-1/4 mr-12 mt-56 text-green-800">
            <h1 id="icu_percentage" className="text-6xl font-sans font-black" />
            <h2 className="text-xl mb-2 whitespace-no-wrap">
              ICU Beds Occupied in{" "}
              <span
                id="state_name"
                className="border-b border-green-800 text-green-800"
                contentEditable
              />
            </h2>
            <p id="icu_heading" className="text-base" />
          </div>
        </main>
